...
export function normalizeYgoPrinting(card,set){
  ...
  return{
    ...
    number:code,collectionNumber:code,setId:slug((set&&set.set_name)||"set"),setCode:code,setName:(set&&set.set_name)||"",
...
export function normalizeYgoSet(s){
  return{game:"yugioh",id:slug(s.set_name),name:s.set_name,cardCount:s.num_of_cards,releaseDate:s.tcg_date,setCode:s.set_code,source:"YGOPRODeck"};
}
